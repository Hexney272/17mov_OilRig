...
Config.OneGasPercentWorth = 550                     -- Hány Ft jár a begyűjtött gáz minden százalékáért (100% = 55.000 Ft alap)
Config.OneQuestPercentWorth = 200                    -- Hány Ft jár a mellékfeladatok minden százalékáért
...
Config.PenaltyAmount = 15000                         -- Büntetés ha a játékos céges jármű nélkül fejezi be a munkát (Ft)
...
Config.RequireAllTeamOnRig = true                   -- Here you force that everyone from lobby needs to be at rig to perform any work action
...
Config.Blips = { -- Here you can configure Company blip.
    [1] = {
        ...
        Label = 'Olajfúró Munka'
    },
}

Config.BlipsStyles = {
    EndJob = {
        label = "~b~[OLAJFÚRÓ]~s~ Munka befejezése",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Boat = {
        label = "~b~[OLAJFÚRÓ]~s~ Hajó helye",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Containers = {
        label = "~b~[OLAJFÚRÓ]~s~ Konténer berakodás",
        sprite = 1,
        scale = 0.6,
        color = 26,
    },
    Rig = {
        label = "~b~[OLAJFÚRÓ]~s~ Fúrótorony",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    CarryingProp = {
        label = "~b~[OLAJFÚRÓ]~s~ Szállítási célpont",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Drilling = {
        label = "~b~[OLAJFÚRÓ]~s~ Fúrási feladat",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Welding = {
        label = "~b~[OLAJFÚRÓ]~s~ Hegesztési feladat",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
...
Config.Locations = {       -- Here u can change all of the base job locations.
    DutyToggle = {
        ...
        CurrentActionMsg = 'Nyomd meg az ~INPUT_CONTEXT~ gombot a munka ~y~indításához/befejezéséhez~s~.',
        type = 'duty',
...
Config.Lang = {
    -- Client
    ["no_permission"] = "Csak a csapat tulajdonosa teheti ezt!",
    ["keybind"] = 'Olajfúró Munka Jelölő Interakció',
    ["too_far"] = "A csapatod elkezdte a munkát, de túl messze vagy a központtól",
    ["kicked"] = "Kirúgtad %s-t a csapatból",
    ["alreadyWorking"] = "Először fejezd be az előző megrendelést",
    ["quit"] = "Elhagytad a csapatot",
    ["nobodyNearby"] = "Nincs senki a közelben",
    ["cantInvite"] = "Ahhoz, hogy több embert hívhass meg, először fejezd be a munkát",
    ["inviteSent"] = "Meghívó elküldve!",
    ["spawnpointOccupied"] = "Az autó vagy hajó spawn helye foglalt",
    ["notADriver"] = "A jármű vezetőjének kell lenned a munka befejezéséhez",
    ["partyIsFull"] = "Nem sikerült meghívót küldeni, a csapatod megtelt",
    ["wrongReward1"] = "A kifizetés százalékának 0 és 100 között kell lennie",
    ["wrongReward2"] = "Az összes kifizetés százaléka meghaladta a 100%-ot",
    ["cantLeaveLobby"] = "Nem hagyhatod el a lobbit munka közben. Először fejezd be a munkát.",
    ["lobby_joined"] = "Csatlakoztál a lobbihoz.",
    ["attach_prop"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a konténer csatolásához",
    ["detach_prop"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a konténer leválasztásához",
    ["crane_usage"] = "Használd a ~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ gombokat a daru mozgatásához.~n~Használd a ~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ gombokat a kabin mozgatásához.~n~Használd a ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ gombokat a tartó mozgatásához.~n~Használd a ~INPUT_NEXT_CAMERA~ gombot a nézet váltásához.~n~Nyomd meg az ~INPUT_FRONTEND_PAUSE_ALTERNATE~ gombot a kilépéshez.",
    ["crane_attach"] = "Nyomd meg az ~INPUT_PICKUP~ gombot a konténerek felvételéhez.",
    ["crane_detach"] = "Nyomd meg az ~INPUT_PICKUP~ gombot a konténerek elengedéséhez.",
    ["press_to_pickup"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a felvételhez.",
    ["open_container"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a konténer kinyitásához.",
    ["put_down"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a letételhez.",
    ["load_container_on_boat"] = "Konténer felrakása a hajóra",
    ["startingTutorial"] = "Üdvözlünk az olajfúró platformon! A küldetésed annyi gázt kitermelni, amennyit csak tudsz, mellékfeladatok elvégzésével együtt. Kezdd a konténerek hajóra rakásával. A rakodó járművel emeld fel a konténert és helyezd a hajóra. További utasítások a műszak során jelennek meg. Kezdjünk fúrni!",
    ["loaded_tutorial"] = "Úgy tűnik, minden konténer fel van rakva. A fúróplatformod helye a térképen jelölve van. A teljes legénység szálljon be a hajóba és induljatok a fúrótoronyhoz. Megérkezéskor dokkoljatok a kijelölt helyen",
    ["rig_tutorial"] = "Menj fel a platform tetejére a lépcsőkön. Ha fent vagy, elkezdheted a feladatokat, de ne feledkezz meg a konténerek kirakodásáról. Használd a kijelölt darut ehhez. Ülj be a daruba, és további utasítások fognak megjelenni. Munkára!",
    ["craneTutorial"] = "Menj le a lifttel arra a szintre ahol a hajó parkol. Emelj fel egy konténert és helyezd a kijelölt helyre. Ismételd meg ezt az összes konténerrel",
    ["afterLoadTutorial"] = "Úgy tűnik minden konténer ki van rakodva. Most az a feladatod, hogy kirakd őket. Közelítsd meg az ajtókat a kinyitásukhoz, és oszd el az összes tárgyat a kijelölt helyre",
    ["drill_tutorial"] = "A gázkitermelő géphez értél. Gyorsan elmagyarázzuk a feladatod. Egyre mélyebbre kell fúrnod a csöveket, amíg el nem éred a 100%-os kitermelést. Figyelem: Akár 150%-ig is nyomhatod a gázkitermelést, de minden további fúrás növeli a robbanás kockázatát. Ha felrobban a gáz, elveszíted az összes összegyűjtött gázt, és nem lesz lehetőség folytatni a munkát. Bánj óvatosan és hozz stratégiai döntéseket!",
    ["props_tutorial"] = "Most szét kell osztanod a konténer teljes tartalmát a kijelölt helyekre. Vegyél fel egy tárgyat és a célhely ki fog világítani",
    ["rig_exploded"] = "A gép felrobbant, minden haladás elveszett. Nem tudsz tovább fúrni",
    ["not_in_boat"] = "Nem vagy a hajóban!",
    ["drill_busy"] = "A fúró jelenleg foglalt. Próbáld újra később",
    ["endJobHint"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a munka ~y~befejezéséhez~s~.",
    ["noBoatLocation"] = "Nincs szabad hajó hely",
    ["noHandlerLocation"] = "Nincs szabad rakodó hely",
    ["noContainerLocation"] = "Nincs szabad konténer hely",
    ["noRig"] = "Nincs elérhető munka jelenleg",
    ["endJob"] = "Nyomd meg az ~INPUT_CONTEXT~ gombot a munka ~y~befejezéséhez~s~.",
    ["unableToPerform"] = "Ennek a műveletnek a végrehajtásához a csapat minden tagjának a fúróplatformon kell lennie",

    -- Server
    ["isAlreadyHost"] = "Ez a játékos már vezeti a saját csapatát.",
    ["isBusy"] = "Ez a játékos már egy másik csapathoz tartozik.",
    ["hasActiveInvite"] = "Ennek a játékosnak már van aktív meghívója valakitől.",
    ["HaveActiveInvite"] = "Már van aktív meghívód egy csapathoz.",
    ["InviteDeclined"] = "A meghívódat elutasították.",
    ["InviteAccepted"] = "A meghívódat elfogadták!",
    ["error"] = "Hiba történt a csatlakozás során. Kérlek próbáld újra később.",
    ["kickedOut"] = "Kirúgtak a csapatból!",
    ["reward"] = "Kifizetést kaptál: ",
    ["RequireOneFriend"] = "Ehhez a munkához legalább egy csapattárs szükséges",
    ["penalty"] = "Bírságot fizettél: ",
    ["clientsPenalty"] = "A csapat vezetője elfogadta a büntetést. Nem kaptál kifizetést",
    ["dontHaveReqItem"] = "Neked vagy valamelyik csapattagodnak nincs meg a szükséges tárgy a munka megkezdéséhez",
    ["notEverybodyHasRequiredJob"] = "Nem minden csapattagodnak van meg a szükséges munkakör",
    ["someoneIsOnCooldown"] = "%s nem tudja most elkezdeni a munkát (pihenőidő: %s)",
    ["hours"] = "ó",
    ["minutes"] = "p",
    ["seconds"] = "mp",
    ["newBoss"] = "Az előző lobbitulajdonos elhagyta a szervert. Te vagy mostantól a csapat vezetője",
    ["wait"] = "Kérlek várj néhány másodpercet és próbáld újra",
    ["craneBusy"] = "A daru foglalt. Kérlek próbáld újra később",
    ["finishTask"] = "Mielőtt új feladatba kezdenél, fejezd be a jelenlegit.",

    -- NUI
    ["NUI_weldingJobTitle"] = "Hegesztés",
    ["NUI_weldingJobTitlePlaceholder"] = "MINIJÁTÉKOK",
    ["NUI_instructionWeldingContent"] = "A feladatod hegesztést végezni a jelölt vonalon. Végezd a lehető legnagyobb precizitással, mivel a hegesztés sikere teljes mértékben a pontosságodtól függ. Ne feledd, hogy időkorlát van a feladat befejezésére. A kezdéshez nyomd meg a szóközt vagy az interfész alján lévő gombot.",
    ["NUI_pipesJobTitle"] = "Fúrás",
    ["NUI_pipesJobPlaceholder"] = "MINIJÁTÉKOK",
    ["NUI_instructionPipesContent"] = "A feladatod az előző csövet összekötni a következővel. A cső csatlakoztatásához nyomd meg a szóközt. Ha a csövek túl messze vannak egymástól, a minijáték nem számít sikeresnek. Addig kell fúrnod, amíg el nem éred a 100%-os kitermelést. Figyelem: Akár 150%-ig is nyomhatod a gázkitermelést, de minden további fúrás növeli a robbanás kockázatát. Ha felrobban a gáz, elveszíted az összegyűjtött gázt. A kezdéshez nyomd meg a szóközt vagy az interfész alján lévő gombot.",
    ["NUI_instructionTitle"] = "Útmutató",
    ["NUI_timeTitle"] = "Idő",
    ["NUI_timeContentPrimary"] = "Hátralévő idő...",
    ["NUI_tasksTitle2"] = "Feladatok száma",
    ["NUI_tasksContentPrimary2"] = "Hátralévő feladatok...",
    ["NUI_tasksContentSecondary2"] = "%s/%s feladat",
    ["NUI_tasksTitle"] = "Jelenlegi gáz haladás",
    ["NUI_tasksContentPrimary"] = "Összegyűjtött gáz...",
    ["NUI_tasksContentSecondary"] = "%s%",
    ["NUI_progress"] = "Haladás: %s%",
    ["NUI_gasProgress"] = "Összegyűjtött gáz: %s%",
    ["NUI_startTitle"] = "Indítás",
    ["NUI_buttonStart"] = "Indítás",
    ["NUI_buttonFinish"] = "Befejezés",
    ["NUI_buttonAgain"] = "Újra",
    ["NUI_buttonExit"] = "Kilépés",
    ["NUI_notifySuccess"] = "Feladat teljesítve",
    ["NUI_notifyFailed"] = "Feladat sikertelen",
    ["NUI_signatureTitle"] = "OLAJFÚRÓ MUNKA",
    ["NUI_signatureTitlePlaceholder"] = "OLAJFÚRÓ MUNKA",
    ["NUI_signatureSubtitle"] = "Aláírási dokumentum",
    ["NUI_signatureText"] = "A tárgy letételéhez először írd alá ezt a dokumentumot ",
    ["NUI_signatureError"] = "Alá kell írnod!",
    ["NUI_signatureAccept"] = "Aláírás",
    ["NUI_signatureRetry"] = "Törlés",
    ["NUI_tutorial"] = "Útmutató",
    ["NUI_notification"] = "Értesítés",
    ["NUI_invitation"] = "Meghívó",
    ["NUI_warning"] = "Figyelmeztetés",
    ["NUI_bossName"] = "Vezető neve",
    ["NUI_memberName"] = "Tag neve",
    ["NUI_kickPlayerNotify"] = "A csapat tulajdonosa nem hagyhatja el a csapatot!",
    ["NUI_startJobNotify"] = "Csak a csapat tulajdonosa indíthat munkát!",
    ["NUI_oilRigLobby"] = "OLAJFÚRÓ LOBBI",
}
...
Config.RigsLocations = {
    ...
    [1] = {
        Crane = {
            ...
            MaxZ = 13.0,
            type = "text",
            textMessage = "~r~[E] | ~s~Beszállás a daruba",
        },
        Containers = {
            ContainerCoords = {
        ...
        BoatParking = {
            ...
            HelpNotification = "Nyomd meg az ~INPUT_CONTEXT~ gombot a hajó parkolásához.",
            type = "marker",
        },
        ContainerContent = {
            [1] = {
